 ...
 *
 */
public class FormatRuntimeException extends CommonRuntimeException {
	...
	public FormatRuntimeException(String message, Object[] param) {
		super(message, param);
	}
	...
	public FormatRuntimeException(String message, Object[] param, Throwable cause) {
