...
import com.tools.transaction.spi.support.TransactionSynchronizationAdapter;
 ...
 * @see com.tools.transaction.spi.support.TransactionSynchronizationManager
 */
public abstract class DataSourceUtils {
	...
	private static final ILogger logger = LoggerFactory.getLogger(DataSourceUtils.class);
	...
	public static void applyTimeout(Statement stmt, DataSource dataSource, int timeout) throws SQLException {
		if (stmt == null) {
			throw new IllegalArgumentException("No Statement specified!");
		}
		if (dataSource == null) {
			throw new IllegalArgumentException("No dataSource specified!");
		}
