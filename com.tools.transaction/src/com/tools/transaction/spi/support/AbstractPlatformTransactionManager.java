...
import com.tools.transaction.impl.Constants;
import com.tools.transaction.spi.IllegalTransactionStateException;
import com.tools.transaction.spi.InvalidTimeoutException;
import com.tools.transaction.spi.NestedTransactionNotSupportedException;
import com.tools.transaction.spi.PlatformTransactionManager;
import com.tools.transaction.spi.TransactionDefinition;
import com.tools.transaction.spi.TransactionException;
import com.tools.transaction.spi.TransactionStatus;
import com.tools.transaction.spi.TransactionSuspensionNotSupportedException;
import com.tools.transaction.spi.UnexpectedRollbackException;
...
public abstract class AbstractPlatformTransactionManager implements PlatformTransactionManager, Serializable {
	...
	protected transient ILogger logger = LoggerFactory.getLogger(getClass());

	/**
	 * Always activate transaction synchronization, even for "empty" transactions
	 * that result from PROPAGATION_SUPPORTS with no existing backend transaction.
	 * @see com.tools.transaction.spi.TransactionDefinition#PROPAGATION_SUPPORTS
	 * @see com.tools.transaction.spi.TransactionDefinition#PROPAGATION_NOT_SUPPORTED
	 * @see com.tools.transaction.spi.TransactionDefinition#PROPAGATION_NEVER
	 */
	 ...
	 * @see com.tools.transaction.spi.TransactionDefinition#PROPAGATION_REQUIRED
	 * @see com.tools.transaction.spi.TransactionDefinition#PROPAGATION_MANDATORY
	 * @see com.tools.transaction.spi.TransactionDefinition#PROPAGATION_REQUIRES_NEW
	 */
	 ...
	 * @see com.tools.transaction.spi.TransactionDefinition#TIMEOUT_DEFAULT
	 */
	 ...
	 * @see com.tools.transaction.spi.UnexpectedRollbackException
	 */
	 ...
	 * @see com.tools.transaction.spi.TransactionDefinition#getTimeout()
	 ...
	 * and {@code rollback}.
	 * @see com.tools.transaction.spi.TransactionStatus#isRollbackOnly()
	 * @see #doCommit
	 * @see #rollback
	 */
	 ...
	 * @throws com.tools.transaction.spi.CannotCreateTransactionException
	 ...
	 * @throws com.tools.transaction.spi.TransactionSuspensionNotSupportedException
	 ...
	 * @see com.tools.transaction.spi.TransactionStatus#setRollbackOnly()
	 * @see com.tools.transaction.spi.UnexpectedRollbackException
